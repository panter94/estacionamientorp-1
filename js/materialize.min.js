...
/*! Guardar datos */
var app = angular.module('AppOpt', ['firebase']);
app.controller('CtrlOpt', function($scope, $firebaseArray){

    var dbRef = firebase.database().ref('Registros');
    $scope.registros = $firebaseArray(dbRef);

    $scope.agregarContacto = function(){
        var objeto = {nombre: "Ramzes", numero: "4921617825"};
        $scope.registros.$add(objeto)
        .then(function(ref){
            console.log('El objeto se ha guardado')
        })
        .catch(function(err){
    ...
    $scope.borrarContacto = function(_index){
        var objeto = $scope.registros[_index];
        $scope.registros.$remove(objeto)
        .then(function(ref){
            console.log('El objeto se ha borrado')
        })
        .catch(function(err){
            console.log('Ha ocurrido un error al borrar el objeto')
        });
    }

    $scope.modificarContacto = function(_index){
        var objeto = $scope.registros[_index];
        objeto.nombre = 'Panter';
        objeto.numero = '4921457397';
        $scope.registros.$save(objeto)
        .then(function(ref){
            console.log('El objeto se ha modificado')
        })
        .catch(function(err){
            console.log('Ha ocurrido un error al modificar el objeto')
        });
    }
